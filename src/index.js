...
function getDashboardHTML() {
  const html = [
    ...
    '<canvas id="c"></canvas>',
    '<div class="wrap">',
    '<h1 style="color:#cc44ff;text-shadow:0 0 12px #cc44ff,0 0 25px #8800ff,0 0 3px #00ffff;">&#11041; BRA GT ELITE</h1>',
    '<div class="sub" style="font-size:1.1em;color:#00e5ff;text-shadow:0 0 8px #00e5ff,0 0 20px #0099cc;letter-spacing:2px;">BAXTO STYLE TATTOO &mdash; METAWORK DASHBOARD</div>',
    '<div class="grid">',
