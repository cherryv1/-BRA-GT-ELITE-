...
function getDashboardHTML() {
  const html = [
    ...
    '<button class="hamburger-btn" onclick="document.getElementById(\"modal-chat\").classList.add(\"active\")">💬 CHAT ÉLITE</button>',
    '<button class="hamburger-btn" onclick="document.getElementById(\"modal-rules\").classList.add(\"active\")">📋 REGLAS ÉLITE</button>',
    '</div>',
    '<div id="modal-chat" class="modal">',
    '<div class="modal-content">',
    '<button class="modal-close" onclick="document.getElementById(\"modal-chat\").classList.remove(\"active\")">✕</button>',
    '<h2 style="color:#00f5ff;margin-bottom:16px;">💬 CHAT BRA GT ELITE</h2>',
    '<div id="chat-box" style="background:rgba(0,10,0,.9);border:1px solid rgba(0,255,65,.2);border-radius:8px;height:300px;overflow-y:auto;padding:.8rem;margin-bottom:.8rem;display:flex;flex-direction:column;gap:.5rem;"></div>',
    '<div style="display:flex;gap:8px">',
    '<input id="chat-input" type="text" placeholder="Mensaje..." onkeydown="if(event.key==\"Enter\")sendChat()" style="flex:1;margin:0;">',
    ...
    '<div class="modal-content">',
    '<button class="modal-close" onclick="document.getElementById(\"modal-rules\").classList.remove(\"active\")">✕</button>',
    '<h2 style="color:#00f5ff;margin-bottom:16px;">📋 REGLAS RLHF ÉLITE</h2>',
    '<table style="width:100%;border-collapse:collapse;font-size:.9em;"><thead><tr><th style="color:#00f5ff;text-align:left;padding:8px;border-bottom:1px solid rgba(0,255,65,.3);">Trigger</th><th style="color:#00f5ff;text-align:left;padding:8px;border-bottom:1px solid rgba(0,255,65,.3);">Respuesta</th><th></th></tr></thead>',
    ...
    '<div id="rule-status"></div></div></div>',
        '<div style="display:grid;grid-template-columns:1fr 420px;gap:24px;margin-bottom:20px;">',
    '<div style="background:rgba(0,5,20,0.9);border:1px solid rgba(0,245,255,0.15);border-radius:16px;padding:20px;"><h2 style="color:#00f5ff;margin-bottom:16px;">📋 REGLAS RLHF ÉLITE</h2><table id="rulesList" style="width:100%;"></table></div>',
    '<div style="background:linear-gradient(135deg,rgba(0,5,20,0.95) 0%,rgba(10,0,30,0.95) 100%);border:1px solid rgba(157,0,255,0.3);border-radius:20px;padding:20px;height:500px;display:flex;flex-direction:column;"><div style="background:linear-gradient(90deg,#9d00ff 0%,#00f5ff 100%);padding:12px;color:#000;font-weight:bold;border-radius:12px;margin-bottom:12px;">💬 CHAT BRA GT ELITE</div><div id="chat-box" style="flex:1;overflow-y:auto;margin-bottom:12px;"></div><input id="chat-input" type="text" placeholder="Mensaje..." style="padding:8px;border-radius:8px;border:1px solid #9d00ff;margin-bottom:8px;"><button onclick="sendChat()" style="padding:8px 16px;background:#9d00ff;color:#fff;border:none;border-radius:8px;cursor:pointer;">➤ SEND</button></div>',
    '</div>',
