...
function getDashboardHTML() {
  const html = [
    ...
    '<h2 style="color:#00ff88;font-family:Orbitron,monospace;font-size:.9em;margin-bottom:16px;">💬 CHAT BRA GT</h2>',
    '<div id="chat-box" style="height:300px;overflow-y:auto;margin-bottom:12px;"></div>',
    '<div style="display:flex;gap:8px">',
    '<input id="chat-input" type="text" placeholder="Mensaje..." onkeydown="if(event.key===\'Enter\')sendChat()" style="margin:0;flex:1">',
