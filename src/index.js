...
function getDashboardHTML() {
  const html = [
    ...
    '<canvas id="c"></canvas>',
    '<div class="wrap">',
    '<h1 style="color:#ff3333;text-shadow:0 0 8px #ffdd00,0 0 2px #3399ff,-1px -1px 0 #3399ff,1px -1px 0 #3399ff,-1px 1px 0 #3399ff,1px 1px 0 #3399ff;">&#11041; BRA GT ELITE</h1>',
    '<div class="sub" style="font-size:1.2em;color:#ffffff;text-shadow:0 0 10px #ffffff,0 0 3px #3399ff,-1px -1px 0 #3399ff,1px 1px 0 #3399ff;">BAXTO STYLE TATTOO &mdash; METAWORK DASHBOARD</div>',
    '<div class="grid">',
